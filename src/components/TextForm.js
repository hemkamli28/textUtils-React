...
export default function TextForm(props) {
  ...
  return (
    <>
        ...
        <button className="btn btn-warning mx-3 my-4" onClick={handleUpClick}>Convert to UpperCase</button>
        <button className="btn btn-warning mx-3" onClick={handleLowClick}>Convert to LowerCase</button>
        <button className="btn btn-warning mx-3" onClick={handleClClick}>Clear Text</button>
        <button className="btn btn-warning mx-3" onClick={handleCopy}>Copy Text</button>
        <button className="btn btn-warning mx-2" onClick={handlExSpace}>Remove Extra Space</button>
        </div>
